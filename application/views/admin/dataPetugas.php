						...
						<div class="col-12 d-flex">
							<div class="card flex-fill" style="min-height: 330px;">
								<div class="row py-3">
                                    ...
                                    <div class="col-2">
									<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap">Add Petugas</button>
									...
									<!-- Modal tambah buku -->
										...
										<div class="modal-dialog">
											...
											<div class="modal-body">
												<form method="post" action="<?= base_url('admin/tambahPetugas') ?>">
													<div class="row">
														<div class="col-6">
															<div class="mb-3">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a href="<?= base_url() ?>admin/hapusPetugas/<?= $dp['UserID'] ?>" class="btn btn-danger" onclick="return confirm('yakin?')"><i data-feather="trash"></i></a>
												<a href="" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditPetugas<?= $dp['UserID'] ?>"><i data-feather="edit"></i></a>

												<!-- Modal edit petugas -->
												<div class="modal fade" id="modalEditPetugas<?= $dp['UserID'] ?>" tabindex="-1" aria-labelledby="modalEditPetugasLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="modalEditPetugasLabel">Edit Petugas</h5>
															<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
														</div>
														<div class="modal-body">
															<form method="post" action="<?= base_url() ?>admin/editPetugas/<?= $dp['UserID'] ?>">
																<div class="row">
																	<div class="col-6">
																		<div class="mb-3">
																			<label for="recipient-name" class="col-form-label">Nama Lengkap:</label>
