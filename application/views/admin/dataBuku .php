                                    ...
                                    <div class="col-10">
										...
										<div class="row">
											...
											<select name="sortir_buku" id="" class="form-control form-select">
												...
												<option value="<?= $dk['NamaKategori'] ?>"><?= $dk['NamaKategori'] ?></option>
												<?php endforeach; ?>
											</select>
											</div>
											<div class="col-3">
								...
								<table class="table table-hover my-0">
									...
									<tbody>
										...
										<tr>
											...
											<td><?= $db->Penerbit ?></td>
											<td class="d-none d-md-table-cell"><?= $db->Stok ?></td>
											<td>
												...
												<a href="<?= base_url() ?>admin/hapusBuku/<?= $db->BukuID ?>" class="btn btn-danger" onclick="return confirm('yakin?')"><i data-feather="trash"></i></a>
												...
												<!-- Modal edit buku -->
													...
													<div class="modal-dialog">
														...
														<div class="modal-body">
															<?php echo form_open_multipart('admin/editBuku/' .$db->BukuID); ?>
																<div class="row">
																	<div class="col-6">
																		<div class="mb-3">
																			<label for="recipient-name" class="col-form-label">Judul Buku:</label>
																	...
																	<div class="col-6">
																		<div class="mb-3">
																			...
																			<select name="kategori_buku" id="" class="form-control form-select">
																				<option value="">Pilih</option>
																				<?php foreach($dataKategori as $dk) : ?>
																					<!-- <option value="<?= $dk['NamaKategori'] ?>" <?= ($dk['NamaKategori'] == $db['JenisBuku']) ? 'selected' : '' ?>><?= $dk['NamaKategori'] ?></option> -->
																				<?php endforeach; ?>
																			</select>
																			<?= form_error('kategori_buku', '<small class="text-danger">', '</small>'); ?>
																		</div>
